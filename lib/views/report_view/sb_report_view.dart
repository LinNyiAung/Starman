...
class _SbReportView extends State<SbReportView> {
  ...
  Future<void> _loadSbDataFromFile() async {
    try {
      ...
      if (file.existsSync()) {
        ...
        _updateCategories(); // Update categories after loading data
      } else {
  ...
  void _updateCategories() {
    if (starSBData.isNotEmpty) {
      List<dynamic> stockBalanceList = starSBData[0]['starStockBalanceList'];
      ...
      children: [
        DropdownButton<String>(
          ...
          onChanged: (String? newValue) async {
            ...
            _updateCategories(); // Update categories after new data is loaded
          },
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              onPressed: () async {
                await _downLoadData(); _updateCategories();
              },
              icon: Icon(
